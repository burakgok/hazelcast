...
class CompactUpsertTarget extends UpsertTarget {
    ...
    CompactUpsertTarget(String typeName, Map<String, Schema> schemas) {
    ...
    public UpsertInjector createInjector(@Nullable String path, QueryDataType type) {
        ...
        if (!schemas.get(typeName).hasField(path)) {
            return value -> {
        ...
        switch (type.getTypeFamily()) {
            ...
            case OBJECT:
                ...
                return (record, value) -> {
                    ...
                    GenericRecordBuilder nestedRecord = new DeserializedSchemaBoundGenericRecordBuilder(fieldSchema);
    ...
    @Override
    public void init() {
        record = new DeserializedSchemaBoundGenericRecordBuilder(schemas.get(typeName));
    }
